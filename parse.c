...
static struct node *makenode(struct parser *p, enum node_kind k, Token tok) {
...
static struct node *makerefexpr(struct parser *p, struct node *rhs, Token amp) {
...
static struct node *makevardecl(struct parser *p, Token name,
